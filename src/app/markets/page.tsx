    ...
    <div style={{ maxWidth: 1400, margin: '0 auto' }}>
      ...
      <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
        ...
        {filtered.map((stock, i) => {
          ...
          return (
            <div key={stock.symbol} style={{ display: 'grid', gridTemplateColumns: '2fr 1.2fr 1fr 1fr 1fr 0.7fr 100px', gap: 0, padding: '14px 20px', borderBottom: i < filtered.length - 1 ? '1px solid var(--border)' : 'none', alignItems: 'center', transition: 'background 0.1s', cursor: 'pointer' }}
